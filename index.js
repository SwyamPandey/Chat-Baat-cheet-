...
app.get("/",(req,res)=>{
    ...
    app.get("/chats",async (req,res)=>{
      ...
      app.get("/chats/new", (req,res)=>{
        ...
        app.get("/chats/:id/edit", async(req,res)=>{ //edit route hae ye 
          let {id}=req.params;
          let chat= await Chat.findById(id);
          res.render("edit.ejs",{chat});
          });
          app.delete("/chats/:id", async(req,res)=>{ //del route hae ye 
            let {id}=req.params;
      ...
      app.post("/chats",(req,res)=>{
        ...
        newchat.save().then((res)=>{console.log("new chat is saved")}).catch((err)=>{console.log(err)});
        res.redirect("/chats");
      });  
